...
class DadosNecessidades extends Model
{
    ...
    protected $fillable = [
        ...
        'rede_apoio_equipamentos',
        'rede_apoio_familia_extensa',
        'rede_apoio_pais_responsaveis',
        'rede_apoio_programas_apoio_comunitario',
        'rede_apoio_programas_protecao',
        'rede_apoio_servico_atendimento_vitimias_maus_tratos',
        'rede_apoio_outros',
